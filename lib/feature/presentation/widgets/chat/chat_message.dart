...
class _AiChatBubbleState extends State<AiChatBubble>
  ...
  void initState() {
    ...
    Future.delayed(const Duration(milliseconds: 800), () {
      ...
      // Auto-open only on larger screens to avoid covering mobile viewport.
      if (screenWidth >= 600) {
        _toggleChat();
          ...
          if (mounted) {
            setState(() {
              _messages.add(_ChatMessage(
                text:
                    "Hi! I'm Cauã's AI assistant. Ask me about his projects or skills!",
        ...
        http
          ...
          onTimeout: () {
            throw TimeoutException(
                'The request exceeded the time limit. Please try again later.');
          },
        ),
  ...
  void _sendMessage() {
    ...
    setState(() {
      _messages.add(
          _ChatMessage(text: text, isUser: true, status: MessageStatus.text));
  ...
  Widget build(BuildContext context) {
    final screenWidth = MediaQuery.of(context).size.width;
    final panelWidth =
        screenWidth < 420 ? (screenWidth - 48).clamp(260.0, 360.0) : 360.0;
    final panelHeight = screenWidth < 420 ? 440.0 : 480.0;
  ...
  Widget _buildMessageBubble(_ChatMessage msg) {
                ...
                builder: (context, child) {
                  ...
                  if (_thinkingController.value >= (index * 0.2)) {
                    final double progress =
                        (_thinkingController.value - (index * 0.2)) / 0.6;
                  ...
                  return Container(
                    ...
                    transform: Transform.translate(offset: Offset(0, offset))
                        .transform,
                    child: Container(
                      width: 8,
                      height: 8,
    ...
    Color bgColor =
        msg.isUser ? const Color(0xFF34D399) : const Color(0xFF1E293B);
...
class _ChatMessage {
  ...
  _ChatMessage(
      {this.text = '', this.isUser = false, this.status = MessageStatus.text});
}
